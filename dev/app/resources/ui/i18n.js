...
(function (global) {
    ...
    const STR = {
        zh: {
            ...
            lowVram: '低显存优化',
            lowVramDesc:
                '尽量关闭 fast 放大、在加载管线后尝试 CPU 分层卸载（仅当引擎提供 Diffusers 式 API 才可能生效）。每次生成结束会卸载管线。说明：整模型常驻 GPU 时占用仍可能接近满配（例如约 24GB），要明显降占用需更短时长/更低分辨率或 FP8 等小权重。',
            ...
            modelRegTitle: '模型仓库',
            coreModelsTitle: '核心模型',
            useMirrorLabel: '国内镜像',
            coreModelDownload: '下载',
            coreModelFailed: '失败',
            hwProfileTitle: '硬件配置推荐',
            hwApplyBtn: '应用推荐',
            modelRegLoading: '加载中...',
            ...
            modelRegFailed: '失败',
            modelRegCheckpoints: '核心模型',
            modelRegDev: '开发模型',
            modelRegUpscalers: '增强模型',
            modelRegLora: 'LoRA模型',
            modelRegSupporting: '辅助模型',
            modelRegOther: '其他模型',
            ...
            stepsLabel: '推理步数',
            videoModel: '视频模型',
            vidModelHint: '蒸馏→8+3步；dev→自定义步数',
            vidModelAutoStandard: '已切换为标准模式（dev模型）',
            cameraMotion: '镜头运动方式',
            ...
            motionAttentionStrength: '注意力强度',
            motionControlLimitHint: '当前 IC-LoRA 架构使用 SimpleDenoiser（无 CFG 引导），且 Union-Control 模型为 canny+depth+pose 联合控制，非专用姿态模型，因此姿态迁移精度有限。提高「注意力强度」可增强参考信号的影响力，但无法达到 ControlNet 级别的精确控制。',
            forceCancelLog: '⚠️ 正在强制取消 — 释放GPU显存，下次生成需重新加载模型...',
            forceCancelFail: '强制取消失败',
            motionTransferHint:
            ...
            motionVideoDuration: '📏 参考视频时长: {duration}s，已自动同步',
            ...
            ratioCustom: '自定义尺寸',
            imgModelLabel: '图像模型',
            imgModelDefault: '默认 Z-Image-Turbo',
            width: '宽度',
            height: '高度',
            ...
            ttsTranscribeBtn: '🔍 识别为文字',
            ttsTranscribing: '⏳ 识别中...',
            ttsTranscribeOk: '语音识别完成',
            ttsTranscribeFail: '语音识别失败',
            ttsTranscribeEmpty: '识别结果为空',
            tabAsr: '语音识别',
            asrStatusBarDetecting: '🔍 正在检测语音识别模型...',
            asrStatusReady: '✅ faster-whisper 就绪',
            asrStatusNotAvail: '⚠️ faster-whisper 未安装，请运行: uv pip install faster-whisper',
            asrStatusConnErr: '❌ 无法连接后端: ',
            asrUploadTitle: '上传音频 / Upload Audio',
            asrUploadHint: '点击上传音频文件 (.wav / .mp3 / .flac)',
            asrResultTitle: '识别结果 / Result',
            asrCopyBtn: '📋 复制',
            asrRunBtn: '🔍 开始识别',
            asrRunBusy: '⏳ 识别中...',
            asrRunOk: '语音识别完成',
            asrRunFail: '语音识别失败',
            asrResultEmpty: '（识别结果为空）',
            motionSpeedLabel: '运动速度',
            motionSpeedHint: '调整视频动态强度，1.0为默认速度',
            envCheckTitle: '环境检测',
            envDetect: '检测',
            envScanning: '正在扫描环境...',
            ...
            envFixFailed: '修复失败',
            tabUpscale: '高清放大',
            upscaleSubtabVideo: '🎬 视频放大',
            upscaleSubtabImage: '🖼️ 图片放大',
            upscaleStatusBarDetecting: '🔍 正在检测放大引擎...',
            upscaleVideoTitle: '视频高清放大 / Video Upscale',
            upscaleInputVideo: '输入视频',
            upscaleVideoUploadHint: '点击或拖拽视频文件',
            upscaleImageTitle: '图片高清放大 / Image Upscale',
            upscaleInputImage: '输入图片',
            upscaleImageUploadHint: '点击或拖拽图片文件',
            upscaleParamsTitle: '放大参数 / Parameters',
            upscaleEngine: '放大引擎',
            upscaleEngineRealESRGAN: 'Real-ESRGAN (高保真)',
            upscaleEngineLtxFast: 'LTX 快速放大',
            upscaleScale: '放大倍数',
            upscaleScale2x: '2倍 (2x)',
            upscaleScale4x: '4倍 (4x)',
            upscaleModel: '放大模型',
            upscaleModelX4Plus: '通用 x4plus',
            upscaleModelAnime: '动漫 x4plus-anime',
            upscaleModelX2Plus: '通用 x2plus',
            upscaleRatioLabel: '画面比例',
            upscaleRatioOriginal: '原始比例',
            upscaleRatio169: '16:9 宽屏',
            upscaleRatio916: '9:16 竖屏',
            upscaleRatio219: '21:9 超宽屏',
            upscaleRatio32: '3:2 经典',
            upscaleRatio43: '4:3 标准',
            upscaleRatio11: '1:1 方形',
            upscaleQualityLabel: '目标清晰度',
            upscaleTargetScale: '按倍数放大',
            upscaleTarget720p: '720P 高清',
            upscaleTarget1080p: '1080P 全高清',
            upscaleTarget2k: '2K 超清',
            upscaleTarget4k: '4K 极清',
            upscaleTargetCustom: '自定义尺寸',
            upscaleOriginalQualityHint: '保持原始比例，短边达到 {quality} 标准',
            upscaleTargetWidth: '目标宽度',
            upscaleTargetHeight: '目标高度',
            upscaleResizeModeLabel: '缩放模式',
            upscaleResizeFit: '适应（保持比例，可能留黑边）',
            upscaleResizeCrop: '裁剪（保持比例，裁剪多余部分）',
            upscaleResizeStretch: '拉伸（填充到指定尺寸）',
            upscaleDenoiseLabel: '降噪强度',
            upscaleDenoiseHint: '0=保留原始细节，1=强力降噪',
            upscaleAdvancedSettings: '⚙ 高级设置',
            upscaleTileSizeLabel: '分块大小 (Tile)',
            upscaleTileSizeHint: '0=自动根据显存设置，值越小越省显存但越慢',
            upscaleTileAuto: '自动 ({val})',
            upscaleTileAutoCpu: '自动 (CPU)',
            upscaleFpsLabel: '输出帧率',
            upscaleFpsOriginal: '不调整（保持原始帧率）',
            upscaleFps16: '16 fps',
            upscaleFps24: '24 fps',
            upscaleFps30: '30 fps',
            upscaleFps60: '60 fps',
            upscaleFpsCustom: '自定义帧数',
            upscaleFpsHint: '低于原始帧率=抽帧，高于原始帧率=插帧',
            upscaleProgressTitle: '放大进度',
            upscaleProgressPreparing: '准备中...',
            upscaleProgressRunning: '正在高清处理...',
            upscaleProgressDone: '放大完成！',
            upscaleResultTitle: '放大结果 / Result',
            upscaleDownload: '⬇️ 下载结果',
            upscaleOpenFolder: '📂 打开目录',
            upscaleGenBtn: '🔍 开始高清放大',
            upscaleGenRunning: '放大中...',
            upscaleWarnNoVideo: '请先上传视频文件',
            upscaleWarnNoImage: '请先上传图片文件',
            upscaleDone: '{type}放大完成 ({scale}x)',
            upscaleFailed: '放大失败',
            upscaleElapsed: '耗时',
            upscaleInstallFailed: '安装失败',
        },
        en: {
            tabVideo: 'Video',
            tabBatch: 'Frames',
            tabMotion: 'Transfer',
            subtabI2v: 'Standard',
            subtabBatch: 'Multi-Frame',
            subtabMotion: 'Transfer',
            tabImage: 'Image',
            promptLabel: 'Prompt',
            ...
            coreModelsTitle: 'Core Models',
            useMirrorLabel: 'CN Mirror',
            coreModelDownload: 'Download',
            coreModelFailed: 'Failed',
            hwProfileTitle: 'Hardware Profile',
            hwApplyBtn: 'Apply',
            ...
            modelRegCheckpoints: 'Core Models',
            modelRegDev: 'Dev',
            modelRegUpscalers: 'Upscalers',
            modelRegLora: 'LoRA Models',
            modelRegSupporting: 'Supporting Models',
            modelRegOther: 'Other',
            ...
            vidModelHint: 'Distilled → 8+3 steps; Dev → custom steps',
            vidModelAutoStandard: 'Switched to standard mode (dev model)',
            ...
            motionAttentionStrength: 'Attention strength',
            motionControlLimitHint: 'The current IC-LoRA architecture uses SimpleDenoiser (no CFG guidance), and the Union-Control model combines canny+depth+pose rather than being a dedicated pose model, so pose transfer accuracy is limited. Increasing "Attention strength" can enhance the reference signal influence, but cannot achieve ControlNet-level precision.',
            forceCancelLog: '⚠️ Force cancelling — releasing GPU memory, next generation will need to reload models...',
            forceCancelFail: 'Force cancel failed',
            motionTransferHint:
            ...
            motionVideoDuration: '📏 Reference video: {duration}s, duration synced',
            ...
            ratio916: '9:16 Portrait',
            ratio43: '4:3 Classic',
            ratio34: '3:4 Classic Portrait',
            ratio219: '21:9 Ultrawide',
            ratio921: '9:21 Ultra Portrait',
            ratioCustom: 'Custom Size',
            imgModelLabel: 'Image Model',
            imgModelDefault: 'Default Z-Image-Turbo',
            width: 'Width',
            height: 'Height',
            samplingSteps: 'Steps',
            ...
            ttsTranscribeBtn: '🔍 Transcribe',
            ttsTranscribing: '⏳ Transcribing...',
            ttsTranscribeOk: 'Transcription complete',
            ttsTranscribeFail: 'Transcription failed',
            ttsTranscribeEmpty: 'Transcription result is empty',
            tabAsr: 'ASR',
            asrStatusBarDetecting: '🔍 Checking ASR model...',
            asrStatusReady: '✅ faster-whisper ready',
            asrStatusNotAvail: '⚠️ faster-whisper not installed. Run: uv pip install faster-whisper',
            asrStatusConnErr: '❌ Cannot connect to backend: ',
            asrUploadTitle: 'Upload Audio',
            asrUploadHint: 'Click to upload audio (.wav / .mp3 / .flac)',
            asrResultTitle: 'Result',
            asrCopyBtn: '📋 Copy',
            asrRunBtn: '🔍 Start Transcription',
            asrRunBusy: '⏳ Transcribing...',
            asrRunOk: 'Transcription complete',
            asrRunFail: 'Transcription failed',
            asrResultEmpty: '(No transcription result)',
            motionSpeedLabel: 'Motion Speed',
            motionSpeedHint: 'Adjust video motion intensity, 1.0 is default',
            ...
            envFixFailed: 'Failed',
            tabUpscale: 'Upscale',
            upscaleSubtabVideo: '🎬 Video',
            upscaleSubtabImage: '🖼️ Image',
            upscaleStatusBarDetecting: '🔍 Checking upscale engines...',
            upscaleVideoTitle: 'Video Upscale',
            upscaleInputVideo: 'Input Video',
            upscaleVideoUploadHint: 'Click or drag video file',
            upscaleImageTitle: 'Image Upscale',
            upscaleInputImage: 'Input Image',
            upscaleImageUploadHint: 'Click or drag image file',
            upscaleParamsTitle: 'Parameters',
            upscaleEngine: 'Engine',
            upscaleEngineRealESRGAN: 'Real-ESRGAN (Hi-Fi)',
            upscaleEngineLtxFast: 'LTX Fast Upscale',
            upscaleScale: 'Scale',
            upscaleScale2x: '2x',
            upscaleScale4x: '4x',
            upscaleModel: 'Model',
            upscaleModelX4Plus: 'General x4plus',
            upscaleModelAnime: 'Anime x4plus-anime',
            upscaleModelX2Plus: 'General x2plus',
            upscaleRatioLabel: 'Aspect Ratio',
            upscaleRatioOriginal: 'Original Ratio',
            upscaleRatio169: '16:9 Widescreen',
            upscaleRatio916: '9:16 Portrait',
            upscaleRatio219: '21:9 Ultrawide',
            upscaleRatio32: '3:2 Classic',
            upscaleRatio43: '4:3 Standard',
            upscaleRatio11: '1:1 Square',
            upscaleQualityLabel: 'Target Quality',
            upscaleTargetScale: 'Scale by multiplier',
            upscaleTarget720p: '720P HD',
            upscaleTarget1080p: '1080P FHD',
            upscaleTarget2k: '2K QHD',
            upscaleTarget4k: '4K UHD',
            upscaleTargetCustom: 'Custom Size',
            upscaleOriginalQualityHint: 'Keep original ratio, short side meets {quality}',
            upscaleTargetWidth: 'Target Width',
            upscaleTargetHeight: 'Target Height',
            upscaleResizeModeLabel: 'Resize Mode',
            upscaleResizeFit: 'Fit (keep ratio, may add bars)',
            upscaleResizeCrop: 'Crop (keep ratio, crop excess)',
            upscaleResizeStretch: 'Stretch (fill to target size)',
            upscaleDenoiseLabel: 'Denoise Strength',
            upscaleDenoiseHint: '0=keep original detail, 1=strong denoise',
            upscaleAdvancedSettings: '⚙ Advanced Settings',
            upscaleTileSizeLabel: 'Tile Size',
            upscaleTileSizeHint: '0=auto based on VRAM, smaller=less VRAM but slower',
            upscaleTileAuto: 'Auto ({val})',
            upscaleTileAutoCpu: 'Auto (CPU)',
            upscaleFpsLabel: 'Output Frame Rate',
            upscaleFpsOriginal: 'No adjustment (keep original)',
            upscaleFps16: '16 fps',
            upscaleFps24: '24 fps',
            upscaleFps30: '30 fps',
            upscaleFps60: '60 fps',
            upscaleFpsCustom: 'Custom fps',
            upscaleFpsHint: 'Lower than original=frame skip, higher=frame interpolation',
            upscaleProgressTitle: 'Progress',
            upscaleProgressPreparing: 'Preparing...',
            upscaleProgressRunning: 'Upscaling...',
            upscaleProgressDone: 'Upscale complete!',
            upscaleResultTitle: 'Result',
            upscaleDownload: '⬇️ Download',
            upscaleOpenFolder: '📂 Open Folder',
            upscaleGenBtn: '🔍 Start Upscale',
            upscaleGenRunning: 'Upscaling...',
            upscaleWarnNoVideo: 'Please upload a video first',
            upscaleWarnNoImage: 'Please upload an image first',
            upscaleDone: '{type} upscale done ({scale}x)',
            upscaleFailed: 'Upscale failed',
            upscaleElapsed: 'Elapsed',
            upscaleInstallFailed: 'Install failed',
        },
    };
