...
(function (global) {
    ...
    const STR = {
        zh: {
            ...
            hwApplyBtn: '应用推荐',
            modelRequiredHint: '需要先下载此模型才能使用此功能',
            modelRequiredDownload: '立即下载',
            modelRequiredDownloading: '下载中',
            modelRequiredDownloadFailed: '下载失败',
            modelRequiredClose: '关闭',
        ...
        en: {
            ...
            hwApplyBtn: 'Apply',
            modelRequiredHint: 'This model must be downloaded before using this feature',
            modelRequiredDownload: 'Download now',
            modelRequiredDownloading: 'Downloading',
            modelRequiredDownloadFailed: 'Download failed',
            modelRequiredClose: 'Close',
